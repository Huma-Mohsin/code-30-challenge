...
function StringToNumber(str) {
    var result1 = parseFloat(str); //parseFloat:parseFloat is used to parse strings into floating-point numbers (numbers with decimal points).
    var result2 = parseInt(str); //parseInt:parseInt is used to parse strings into integers.
